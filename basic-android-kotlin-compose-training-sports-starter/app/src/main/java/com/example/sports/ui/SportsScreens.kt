    ...
    Scaffold(
        ...
        if (contentType == SportsContentType.ListAndDetail) {
            ...
            SportsListAndDetails(
                ...
                onClickList = { viewModel.updateCurrentSport(it) },
...
fun SportsListAndDetails(
    sports: List<Sport>,
    onClickList: (Sport) -> Unit,
    selectedSport: Sport,
    onClickBackButton: () -> Unit,
    detailContentPaddingValues: PaddingValues = PaddingValues(0.dp),
    ...
    Row(modifier = modifier) {
        ...
        SportsDetail(
            ...
            onBackPressed = onClickBackButton,
            contentPadding = detailContentPaddingValues,
